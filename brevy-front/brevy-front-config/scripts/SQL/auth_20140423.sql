...
prompt Created on 2014年4月23日 by dell
set feedback off
set define off
...
prompt Dropping ATEST...
drop table ATEST cascade constraints;
prompt Dropping BTEST...
drop table BTEST cascade constraints;
...
values (1, 1000, '管理员-AAP', 'AdminAAP', '/**/*.*', 'authcCustom', 'roles', '1', 999999999, null, null, null, null);
insert into AP_ACCESS_PERM (id, app_id, name, code, url_pattern, authentication_filter, authorization_filter, status, sort, creator, create_time, updator, update_time)
...
values (1, 1000, -1, null, null, '/WEB-INF/views/', '系统管理', '0', null, 1, '1', 2, null, null, null, null);
insert into AP_MENU (id, app_id, parent_id, code, url, module_location, name, leaf, icon, hierarchy, status, sort, creator, create_time, updator, update_time)
...
insert into AP_MENU (id, app_id, parent_id, code, url, module_location, name, leaf, icon, hierarchy, status, sort, creator, create_time, updator, update_time)
values (3, 1000, 115, null, null, '/WEB-INF/views/systemMGR/authCFG/funcMenu/module.xml', '功能菜单配置', '1', 'icon-script_gear', 4, '1', 1, null, null, 'admin', to_timestamp('23-04-2014 10:36:43.344000', 'dd-mm-yyyy hh24:mi:ss.ff'));
insert into AP_MENU (id, app_id, parent_id, code, url, module_location, name, leaf, icon, hierarchy, status, sort, creator, create_time, updator, update_time)
values (4, 1000, 115, null, null, '/WEB-INF/views/systemMGR/authCFG/accessAuth/module.xml', '访问权限配置', '1', 'icon-application_go', 4, '1', 2, null, null, 'admin', to_timestamp('17-04-2014 19:36:18.726000', 'dd-mm-yyyy hh24:mi:ss.ff'));
insert into AP_MENU (id, app_id, parent_id, code, url, module_location, name, leaf, icon, hierarchy, status, sort, creator, create_time, updator, update_time)
values (5, 1000, 115, null, null, '/WEB-INF/views/', '操作权限配置', '1', 'icon-table_gear', 4, '1', 3, null, null, 'admin', to_timestamp('28-03-2014 13:26:34.944000', 'dd-mm-yyyy hh24:mi:ss.ff'));
insert into AP_MENU (id, app_id, parent_id, code, url, module_location, name, leaf, icon, hierarchy, status, sort, creator, create_time, updator, update_time)
values (6, 1000, 2, null, null, '/WEB-INF/views/', '角色配置', '1', 'icon-table_gear', 3, '1', 2, null, null, 'admin', to_timestamp('28-03-2014 13:26:20.416000', 'dd-mm-yyyy hh24:mi:ss.ff'));
insert into AP_MENU (id, app_id, parent_id, code, url, module_location, name, leaf, icon, hierarchy, status, sort, creator, create_time, updator, update_time)
values (7, 1000, 2, null, null, '/WEB-INF/views/', '用户配置', '1', 'icon-user_edit', 3, '1', 5, null, null, 'admin', to_timestamp('17-04-2014 19:36:32.003000', 'dd-mm-yyyy hh24:mi:ss.ff'));
insert into AP_MENU (id, app_id, parent_id, code, url, module_location, name, leaf, icon, hierarchy, status, sort, creator, create_time, updator, update_time)
values (8, 1000, 2, null, null, '/WEB-INF/views/', '用户组配置', '1', 'icon-group_gear', 3, '1', 4, null, null, 'admin', to_timestamp('17-04-2014 19:36:32.003000', 'dd-mm-yyyy hh24:mi:ss.ff'));
insert into AP_MENU (id, app_id, parent_id, code, url, module_location, name, leaf, icon, hierarchy, status, sort, creator, create_time, updator, update_time)
values (9, 1000, 2, null, null, '/WEB-INF/views/', '应用系统配置', '1', 'icon-application_edit', 3, '1', 3, null, null, 'admin', to_timestamp('17-04-2014 19:36:31.910000', 'dd-mm-yyyy hh24:mi:ss.ff'));
insert into AP_MENU (id, app_id, parent_id, code, url, module_location, name, leaf, icon, hierarchy, status, sort, creator, create_time, updator, update_time)
values (10, 1000, -1, null, null, '/WEB-INF/views/', '控件展示', '0', null, 1, '1', 1, null, null, null, null);
insert into AP_MENU (id, app_id, parent_id, code, url, module_location, name, leaf, icon, hierarchy, status, sort, creator, create_time, updator, update_time)
values (11, 1000, 10, null, null, '/WEB-INF/views/', '网格(GRID)', '0', null, 2, '1', 1, null, null, null, null);
insert into AP_MENU (id, app_id, parent_id, code, url, module_location, name, leaf, icon, hierarchy, status, sort, creator, create_time, updator, update_time)
values (12, 1000, 11, null, null, '/WEB-INF/views/', '常规网格', '1', 'icon-application_form_edit', 3, '1', 2, null, null, null, null);
insert into AP_MENU (id, app_id, parent_id, code, url, module_location, name, leaf, icon, hierarchy, status, sort, creator, create_time, updator, update_time)
values (13, 1000, 11, null, null, '/WEB-INF/views/', '分页网格', '1', 'icon-application_delete', 3, '1', 1, null, null, null, null);
insert into AP_MENU (id, app_id, parent_id, code, url, module_location, name, leaf, icon, hierarchy, status, sort, creator, create_time, updator, update_time)
values (115, 1000, 2, null, null, '/WEB-INF/views/', '功能配置', '0', null, 3, '1', 1, 'admin', to_timestamp('14-03-2014 13:28:00.544000', 'dd-mm-yyyy hh24:mi:ss.ff'), 'admin', to_timestamp('23-04-2014 10:34:30.250000', 'dd-mm-yyyy hh24:mi:ss.ff'));
commit;
...
values (1, 1000, '管理员-FUNC', 'FuncAdmin', '1', null, '1', null, null, null, null);
insert into AP_ROLE (id, app_id, name, code, type, desc_, status, creator, create_time, updator, update_time)
values (2, 1000, '管理员-ACCESS', 'AccessAdmin', '2', null, '1', null, null, null, null);
insert into AP_ROLE (id, app_id, name, code, type, desc_, status, creator, create_time, updator, update_time)
values (3, 1000, '管理员-OPER', 'OperAdmin', '3', null, '1', null, null, null, null);
commit;
prompt 3 records loaded
...
insert into AP_SEQ (seq_name, seq_value)
values ('AP_ACCESS_PERM_SEQ', 13);
insert into AP_SEQ (seq_name, seq_value)
values ('AP_OPER_PERM_SEQ', 2);
insert into AP_SEQ (seq_name, seq_value)
values ('AP_MENU_SEQ', 117);
commit;
...
commit;
prompt 1 records loaded
prompt Loading ATEST...
prompt Table is empty
prompt Loading BTEST...
prompt Table is empty
set feedback on
set define on
prompt Done.
