...
prompt Created on 2014年5月9日 by dell
set feedback off
set define off
...
insert into AP_MENU (id, app_id, parent_id, code, url, module_location, name, leaf, icon, hierarchy, status, sort, creator, create_time, updator, update_time)
values (6, 1000, 2, null, null, '/WEB-INF/views/', '角色配置', '1', 'icon-chart_organisation', 3, '1', 2, null, null, 'admin', to_timestamp('09-05-2014 12:04:45.136000', 'dd-mm-yyyy hh24:mi:ss.ff'));
insert into AP_MENU (id, app_id, parent_id, code, url, module_location, name, leaf, icon, hierarchy, status, sort, creator, create_time, updator, update_time)
