 ...
 * @author caobin
 */
Ext.define("App.systemMGR.authCFG.operAuth.crud.OperAuthDelete", {
	extend : "App.Module",
	
	requestUrl: function(){
		return this.getRequestRes("/maintenance/operAuth/delete.json");
	},
	...
	init : function(){
		...
		Ext.Ajax.request({
			...
			loadMask: true,
			loadMaskEl: Ext.getCmp("OperAuthReadMainGridID").getEl(),
