 ...
 * @author caobin
 */
Ext.define("App.systemMGR.authCFG.role.crud.RoleRead", {
	extend : "App.Module",
	
	init : function(){
		return Ext.create("Ext.grid.Panel", {
			id: "RoleReadMainGridID",
	...
	createToolbar : function(){
		...
		return [
			...
			{text: Msg.App.add, iconCls: Ext.ux.Icons.world_add, handler: function(btn){
				Pub.ResLoader.jsPack(me.getExtRes("systemMGR/authCFG/role/ui/crud/RoleCreate.js"), function(){
					me.createInstance("App.systemMGR.authCFG.role.crud.RoleCreate", Msg.App.add, btn.iconCls).show(btn);
				});
			}},
			"-",
			{text: Msg.App.edit, iconCls: Ext.ux.Icons.world_edit, handler:function(btn){
				me.handleSelectedRecord("RoleReadMainGridID", function(p){
					Pub.ResLoader.jsPack(me.getExtRes("systemMGR/authCFG/role/ui/crud/RoleUpdate.js"), function(){
						me.createInstance("App.systemMGR.authCFG.role.crud.RoleUpdate", Msg.App.edit, btn.iconCls, p.sm[0]).show(btn);
					});
				});
			}},
			"-",
			{text: Msg.App.del, iconCls: Ext.ux.Icons.world_delete, handler:function(btn){
				me.handleSelectedRecord("RoleReadMainGridID", function(p){
					Pub.ResLoader.jsPack(me.getExtRes("systemMGR/authCFG/role/ui/crud/RoleDelete.js"), function(){
						Pub.MsgBox.showMsgBox(Pub.MsgBox.CONFIRM, Msg.Prompt.confirmDelRec, null, function(r){
							if(r == "yes"){
								me.createInstance("App.systemMGR.authCFG.role.crud.RoleDelete", Msg.App.del, btn.iconCls, p.sm);
							}	
						});		
					});
				}, null, null, true);
