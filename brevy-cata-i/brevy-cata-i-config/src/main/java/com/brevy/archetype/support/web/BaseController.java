...
import static com.brevy.archetype.support.SupportConstants.WEB_VIEW_RESULT_FAILURE;
...
public abstract class BaseController {
	 ...
	 * @author caobin
	 */
	protected ModelAndView successView(String viewName){
		return createMav(viewName).addObject(WEB_VIEW_RESULT_KEY, WEB_VIEW_RESULT_SUCCESS);
	}
	 ...
	 * @author caobin
	 */
	protected ModelAndView failureView(String viewName, CoreException ce){
		ModelAndView mav = createMav(viewName);
