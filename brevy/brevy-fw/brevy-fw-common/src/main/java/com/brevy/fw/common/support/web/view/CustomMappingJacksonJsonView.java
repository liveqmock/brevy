...
import static com.brevy.fw.common.support.SupportConstants.WEB_RSP_HEAD_ERROR_FIELDS;
...
import com.brevy.fw.common.util.ExceptionUtils;
 ...
 * @version 1.0
 */
public class CustomMappingJacksonJsonView extends MappingJacksonJsonView implements InitializingBean{
	...
	protected Object filterModel(Map<String, Object> model) {
		...
		if(ce != null){
			...
			if(ce.getMessageCode() != null){
				...
				rspHead.put(WEB_RSP_HEAD_ERROR_MESSAGE, ExceptionUtils.getRootCause(ce).getMessage());	
			}	
		}
